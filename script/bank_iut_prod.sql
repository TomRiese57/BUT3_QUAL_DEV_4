...
-- NOTE : l'utilisateur 'a' (référencé par le compte PP1285735733) a été ajouté
-- pour satisfaire la contrainte FK — à remplacer par un vrai utilisateur en prod.
INSERT INTO `utilisateur` (`userId`, `nom`, `prenom`, `adresse`, `userPwd`, `male`, `type`, `numClient`) VALUES
('a',       'A',       'A',    '1, rue inconnue, Metz',            '',                                                                 b'1', 'CLIENT',  '000000000'),
